  ...
  return (
    <div>
      <div className='mx-auto w-full max-w-7xl px-4 py-24 lg:px-8'>
        ...
        <div>
          <p>Welcome to Shrinkr!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Shrinkr’s Website, located at {CLIENT_APP_URL}.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Shrinkr if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing Shrinkr, you agreed to
            use cookies in agreement with the Shrinkr’s Privacy Policy.
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Shrinkr and/or its licensors own the
            intellectual property rights for all material on Shrinkr. All
            intellectual property rights are reserved. You may access this from
            Shrinkr for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul className='mb-4 list-disc pl-8'>
            <li>Republish material from Shrinkr</li>
            <li>Sell, rent or sub-license material from Shrinkr</li>
            <li>Reproduce, duplicate or copy material from Shrinkr</li>
            <li>Redistribute content from Shrinkr</li>
          </ul>
          <p>This Agreement shall begin on the date hereof.</p>
          <p>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            Shrinkr does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Shrinkr,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Shrinkr shall
            not be liable for the Comments or for any liability, damages or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p>
            Shrinkr reserves the right to monitor all Comments and to remove any
          ...
          <p>
            You hereby grant Shrinkr a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Shrinkr; and
          ...
          <p>
            ...
            sending an e-mail to Shrinkr. Please include your name, your
          ...
          <p>
            No use of Shrinkr’s logo or other artwork will be allowed for
