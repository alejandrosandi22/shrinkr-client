      ...
      <div className='relative isolate z-0'>
        ...
        >
          <div
            ...
            className='relative left-[calc(50%)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-primary to-[#9089fc] opacity-30 sm:left-[calc(50%)] sm:w-[72.1875rem]'
          />
        </div>
      </div>
